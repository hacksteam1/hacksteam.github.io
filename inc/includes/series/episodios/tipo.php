...
function episodios() {
	$labels = array(
		'name'                => _x('Episódios', 'Nome do tipo de postagem','mtms'),
		'singular_name'       => _x('Episódios', 'Nome Tipo Singular','mtms'),
		'menu_name'           => __d('Episódios'),
		'name_admin_bar'      => __d('Episódios'),
		);
	$rewrite = array(
	...
	$args = array(
		'label'               => __d('Episódios'),
		'description'         => __d('Gerir Episódios'),
		'labels'              => $labels,
