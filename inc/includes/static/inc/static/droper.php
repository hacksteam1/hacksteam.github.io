...
<div class="dt_boxg">
	...
	<tbody>
		...
		<div class="changelog dt_div_fix"><h2 class="dt_text_h2"><?php _e('Licença ativada, obrigado.','mtms'); ?></h2></div>
		<?php } else { ?>
		<div class="changelog dt_div_fix"><h2 class="dt_text_h2"><?php _e('Ative sua licença para instalar atualizações futuras.','mtms'); ?></h2></div>
		<?php } ?>
		</td>
		</tr>
		<tr>
		...
		<input type="submit" class="button-secondary" name="<?php echo $this->theme_slug; ?>_license_deactivate" value="<?php _e( 'Desativar licença', 'mtms' ); ?>"/>
		<?php } else { ?>
		<input type="submit" class="button-secondary" name="<?php echo $this->theme_slug; ?>_license_activate" value="<?php _e( 'Ativar licença', 'mtms' ); ?>"/>
		<?php } } ?>
		</td>
		</tr>
	</tbody>
