    ...
    class TGM_Plugin_Activation {
        ...
        public function init() {
            ...
            $this->strings = array(
                ...
                'activated_successfully'         => __( 'Plugin ativado com sucesso:', 'tgmpa' ),
        ...
        public function process_bulk_actions() {
            ...
            if ( 'tgmpa-bulk-activate' === $this->current_action() ) {
                ...
                if ( is_wp_error( $activate ) ) {
                    ...
                    printf( '<div id="message" class="updated"><p>%1$s %2$s.</p></div>', _n( 'Plugin ativado com sucesso:', 'The following plugins were activated successfully:', $count, 'tgmpa' ), $imploded );
                }
